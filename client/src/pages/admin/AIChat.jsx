...
import { Send, Loader2, Copy, Eye, Trash2, X, History } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-blue-100">Create amazing content with AI-powered prompts</p>
            </div>
          </div>
          <button
            ...
            <div>
              ...
              <div className="flex gap-3">
                <select
                  ...
                  className="w-96 px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-100 focus:border-blue-500 bg-white transition-all"
                >
