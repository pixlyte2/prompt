...
import PageSectionLoader from "./PageSectionLoader";
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {filteredChannels.map((c) => (
                <tr key={c._id} className="border-b border-gray-50 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 group">
